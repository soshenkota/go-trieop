(() => {
    ...
    function initSliders() {
        if (document.querySelector(".destinations-page__slider")) new swiper_core_Swiper(".destinations-page__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".destinations-page-prev.destinations-page__left",
                nextEl: ".destinations-page-prev.destinations-page__right"
            },
            on: {}
        });
        if (document.querySelector(".customers-page__slider")) new swiper_core_Swiper(".customers-page__slider", {
            modules: [Navigation, Pagination],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
